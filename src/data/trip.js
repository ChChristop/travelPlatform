...
export const events = [
  ...
  E('aburiya','2026-09-27T12:00:00+09:00','2026-09-27T14:00:00+09:00','아부리야 우메다점(あぶりや 梅田店)','오사카','food',{lat:34.7044,lng:135.4989,query:'あぶりや 梅田店',price:'¥5,368',reservation:'예약 예정',note:'카이노미 첫 주문 · 우설/흑모와규 상위코스 제외'}),
  E('to-himeji','2026-09-27T14:00:00+09:00','2026-09-27T15:30:00+09:00','JR 오사카역 → 히메지','히메지','transit',{lat:34.8271,lng:134.6908,transport:'JR'}),
  E('to-nibuno','2026-09-27T15:30:00+09:00','2026-09-27T16:05:00+09:00','히메지역 → 니부노역','히메지','transit',{lat:34.8956,lng:134.7287,transport:'JR 반탄선'}),
  E('taxi-central','2026-09-27T16:05:00+09:00','2026-09-27T16:30:00+09:00','니부노역 → 히메지 센트럴파크','히메지','transit',{lat:34.8798,lng:134.7504,transport:'사전 호출 택시',prep:'택시 호출/승차 위치 확인',prepMinutes:20}),
  E('central-park','2026-09-27T16:30:00+09:00','2026-09-27T19:50:00+09:00','히메지 센트럴파크','히메지','sight',{lat:34.8798,lng:134.7504}),
  E('fireworks','2026-09-27T19:50:00+09:00','2026-09-27T20:05:00+09:00','불꽃놀이','히메지','event',{lat:34.8798,lng:134.7504,prep:'종료 직후 임시버스 승차장 이동',prepMinutes:10}),
  E('bus-osaka','2026-09-27T20:20:00+09:00','2026-09-27T22:00:00+09:00','센트럴파크 → 히메지 → 오사카','오사카','transit',{lat:34.6751,lng:135.5004,transport:'임시버스 + JR'}),
  ...
  E('bajitofu','2026-09-28T18:30:00+09:00','2026-09-28T20:00:00+09:00','바지토후(馬耳東風)','교토','food',{query:'馬耳東風 京都',price:'¥2,500~3,500',reservation:'강력 추천',note:'모모·세세리·네기마·츠쿠네·닭날개 / 내장 제외'}),
  ...
  E('kyorinsen','2026-09-29T12:00:00+09:00','2026-09-29T13:15:00+09:00','텐푸라처 쿄린센(天婦羅処 京林泉)','교토','food',{query:'天婦羅処 京林泉 京都',price:'¥3,500',reservation:'예약 추천',note:'평일 쿄고젠'}),
  ...
  E('kanei','2026-09-29T18:00:00+09:00','2026-09-29T19:15:00+09:00','테우치소바 카네이(手打ち蕎麦 かね井)','교토','food',{query:'手打ち蕎麦 かね井 京都',price:'약 ¥1,900',reservation:'저녁 사전예약 필요',note:'매운무 오로시소바 + 소바두부',prep:'예약시간/이동 확인',prepMinutes:45}),
  ...
  E('kobe-waterfront','2026-09-30T16:00:00+09:00','2026-09-30T18:20:00+09:00','난킨마치 · 구거류지 · 메리켄파크','고베','sight',{lat:34.6826,lng:135.1867}),
  E('rakukanki','2026-09-30T18:30:00+09:00','2026-09-30T20:00:00+09:00','라쿠칸키(楽関記)','고베','food',{query:'楽関記 神戸',price:'약 ¥2,880',reservation:'예약 추천',note:'샤오룽바·찐 닭·가리비·새우 / パクチー抜き'}),
  E('kobe-night','2026-09-30T20:00:00+09:00','2026-09-30T21:30:00+09:00','포트타워 · 하버랜드 · MOSAIC','고베','sight',{lat:34.6796,lng:135.1817}),
...
export const todos = [
  ...
  { id:'r3', label:'바지토후 예약', date:'2026-09-28', priority:3 },
  { id:'r4', label:'쿄린센 예약', date:'2026-09-29', priority:4 },
  { id:'r5', label:'카네이 저녁 예약', date:'2026-09-29', priority:5 },
  { id:'r6', label:'라쿠칸키 예약', date:'2026-09-30', priority:6 },
  { id:'taxi', label:'니부노역 택시 업체/호출시간 확정', date:'2026-09-27', priority:2 },
  { id:'fresh', label:'출발 전 편의점 신상품·날씨·불꽃·교통 최종 확인', date:'2026-09-25', priority:1 },
]
